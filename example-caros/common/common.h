...
/// ================================================================================================
#define LENGTH             (4)
#define IDX_VAL_SIZE       (1)
#define PUBLIC_ARRAY_SIZE  (4)
#define SECRET_ARRAY_SIZE  (4)
#define CONF_SIZE          (sizeof(driver_config_t))


#define MIN_TOTAL_SIZE (IDX_VAL_SIZE + PUBLIC_ARRAY_SIZE + SECRET_ARRAY_SIZE + CONF_SIZE)
